...
public class Constants {
    public static final String COC_TOKEN_HOT_SPOT = BuildConfig.COC_TOKEN_HOT_SPOT;
    public static final String COC_BASE_URL = "https://api.clashofclans.com/v1/players/";
